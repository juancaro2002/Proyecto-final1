...
<h3 style="color:white; text-align:center; ">INSTRUCTORES</h3>
<form action="?c=login&m=auths" method="post">
...
<small style="color:white" id="emailHelp" class="form-text ">Ingrese su contraseña</small>
</div>
<div class="form-group">
...
<small style="color:white" id="emailHelp" class="form-text ">example: 2=instructores</small>
</div>
<br>
